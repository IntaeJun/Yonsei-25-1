...
class Trainer:
    '''
    A class that automates training of a neural network.
    '''
    ...
    def train_step(self):
        # 1. Randomly select a mini-batch
        ...
        # 4. At the end of each epoch, evaluate accuracy
        if self.current_iter % self.iter_per_epoch == 0:
            self.current_epoch += 1
            
            # Use full dataset or sampled subset for evaluation
